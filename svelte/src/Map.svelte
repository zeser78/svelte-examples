<script>
  ...
  import points from "./uvxy.js";

  const yTicks = [0, 2, 4, 6, 8];
  const xTicks = [1980, 1990, 2000, 2010, 2014, 2016];
...
<p>
  Average September extent. Source:
  <a href="https://climate.nasa.gov/vital-signs/arctic-sea-ice/">NSIDC/NASA</a>
</p>
